...
"""autogenerated by genpy from hd_map/elements.msg. Do not edit."""
import sys
...
class elements(genpy.Message):
  _md5sum = "6f63926c2c2a065e0bb8b36cbc47eb9b"
  _type = "hd_map/elements"
...
"""
  __slots__ = ['type','motor_type','elements']
  _slot_types = ['uint8','uint8','hd_map/element[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(elements, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_2B().pack(_x.type, _x.motor_type))
      length = len(self.elements)
      buff.write(_struct_I.pack(length))
      for val1 in self.elements:
        _x = val1
        buff.write(_get_struct_3B().pack(_x.id, _x.color, _x.element_type))
        _v1 = val1.pointclouds
        _v2 = _v1.header
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.type, _x.motor_type,) = _get_struct_2B().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.elements = []
      for i in range(0, length):
        val1 = hd_map.msg.element()
        _x = val1
        start = end
        end += 3
        (_x.id, _x.color, _x.element_type,) = _get_struct_3B().unpack(str[start:end])
        _v4 = val1.pointclouds
        _v5 = _v4.header
        start = end
        end += 4
